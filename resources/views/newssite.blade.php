...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/blog/css/bootstrap-rtl.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/blog/css/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/blog/css/owl.carousel.css')}}">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <a href="" class="logo"><img src="/Content/img/logo.png" alt="" title=""></a>
                <div class="left-side">
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="">اخبار فرهنگی</a></li>
                    <li><a href="">اخبار اقتصادی</a></li>
                    <li><a href="">اخبار اجتماعی</a></li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div class="row">
        ...
        <aside class="col-md-4 col-sm-12 col-xs-12 pull-right">
            ...
            <section class="category-section border-radius">
                ...
                <ul>
                    <li><a href=""> خبر سایسی  <span>10</span></a></li>
                    <li><a href=""> خبر اقتصادی  <span>15</span></a></li>
                    <li><a href=""> خبر اجتماعی  <span>20</span></a></li>
                    <li><a href=""> خبر سایسی  <span>10</span></a></li>
                    <li><a href=""> خبر همینطوری  <span>15</span></a></li>
                    <li><a href=""> خبر سایسی  <span>20</span></a></li>
                    <li><a href=""> خبر سایسی  <span>10</span></a></li>
                </ul>
            </section>
            <!-- most views news -->
...
<script src="{{asset('/blog/js/bootstrap.min')}}"></script>
<script src="{{asset('/blog/js/owl.carousel.js')}}}"></script>
